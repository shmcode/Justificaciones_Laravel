...
Route::middleware(['auth'])->group(function () {
    ...
    // Ruta para generar el reporte PDF con los filtros seleccionados
    Route::get('/teacher/reporte_pdf', [TeacherController::class, 'reportePdf'])
         ->name('teacher.reporte_pdf');
