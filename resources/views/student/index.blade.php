...
<x-app-layout>
  <div class="container mx-auto px-4">
    ...
    <div x-data="{ open: false, selected: {}, showApelacion: false }">
      <h2 class="text-2xl font-bold mb-4 text-custom-blue">Te damos la bienvenida, {{ Auth::user()->name }}!</h2>
      ...
      <div x-data="{ open: false }" class="mb-6 relative">
        ...
        <div x-show="open" @click.away="open = false" x-transition
          ...
          style="display: none;">
          <form method="GET" action="{{ url('/student') }}" class="flex flex-wrap gap-6 items-end">
